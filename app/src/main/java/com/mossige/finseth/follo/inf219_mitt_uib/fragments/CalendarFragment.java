...
public class CalendarFragment extends Fragment {
    ...
    private void getCalendarEvents(final int year, final int month, final int page_num) {
        ...
        JsonArrayRequest calendarEventsRequest = new JsonArrayRequest(Request.Method.GET, UrlEndpoints.getCalendarEventsUrl(ids, exclude, type, startDateString, endDateString, per_page, page_num), (String) null, new Response.Listener<JSONArray>() {
    ...
    private void requestAssignments(final int year, final int month) {
        ...
        JsonArrayRequest calendarEventsRequest = new JsonArrayRequest(Request.Method.GET, UrlEndpoints.getCalendarEventsUrl(ids, exclude, type, startDateString, endDateString, per_page, 1), (String) null, new Response.Listener<JSONArray>() {
